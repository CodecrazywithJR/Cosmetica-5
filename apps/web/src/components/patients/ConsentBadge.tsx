...
export default function ConsentBadge({ 
  ...
  // Error state (neutral - do not break UI)
  if (error || !patient) {
    return (
      <span
        className={`inline-flex items-center font-medium rounded-full border ${sizeClasses} bg-gray-100 text-gray-500 border-gray-200`}
        role="status"
        aria-label="No data"
